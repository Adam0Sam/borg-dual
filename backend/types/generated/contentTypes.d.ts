...
export interface ApiNavigationCollectionNavigationCollection
  extends Schema.CollectionType {
  collectionName: 'navigation_collections';
  info: {
    singularName: 'navigation-collection';
    pluralName: 'navigation-collections';
    displayName: 'Navigation Collection';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    slug: Attribute.UID<
      'api::navigation-collection.navigation-collection',
      'name'
    >;
    name: Attribute.String;
    NavLink: Attribute.Component<'navigation.nav-link', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
